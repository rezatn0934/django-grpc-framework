...
.. currentmodule:: django_grpc_framework_plus.generics
...
``django_grpc_framework_plus.mixins``.

.. currentmodule:: django_grpc_framework_plus.mixins
...
from ``django_grpc_framework_plus.generics``.
...
``GenericService`` and mixin the required handlers::
    ...
    from django_grpc_framework_plus import mixins
    from django_grpc_framework_plus import generics
