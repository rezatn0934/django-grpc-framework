...
_USER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="username",
            full_name="account.User.username",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_USERRETRIEVEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="account.UserRetrieveRequest.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
UserListRequest = _reflection.GeneratedProtocolMessageType(
    "UserListRequest",
    (_message.Message,),
    {
