...
_POST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="title",
            full_name="blog_proto.Post.title",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="content",
            full_name="blog_proto.Post.content",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_POSTRETRIEVEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="blog_proto.PostRetrieveRequest.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
Post = _reflection.GeneratedProtocolMessageType(
    "Post",
    (_message.Message,),
    {
        "DESCRIPTOR": _POST,
...
PostListRequest = _reflection.GeneratedProtocolMessageType(
    "PostListRequest",
    (_message.Message,),
    {
...
PostRetrieveRequest = _reflection.GeneratedProtocolMessageType(
    "PostRetrieveRequest",
    (_message.Message,),
    {
