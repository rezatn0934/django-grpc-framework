...
_PERSONPARTIALUPDATEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="hrm.PersonPartialUpdateRequest.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="hrm.PersonPartialUpdateRequest.name",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="email",
            full_name="hrm.PersonPartialUpdateRequest.email",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_PERSONPARTIALUPDATEREQUEST.fields_by_name["name"].message_type = (
    google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
)
_PERSONPARTIALUPDATEREQUEST.fields_by_name["email"].message_type = (
    google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
)
DESCRIPTOR.message_types_by_name["Person"] = _PERSON
DESCRIPTOR.message_types_by_name["PersonPartialUpdateRequest"] = (
...
PersonPartialUpdateRequest = _reflection.GeneratedProtocolMessageType(
